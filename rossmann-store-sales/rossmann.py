...
features = ['Store_a', 'Store_b', 'Store_c', 'Store_d', 'Store_e', "DayOfWeek", "Open", "Promo", "StateHoliday",
...
categorical_features = [
    header in ["DayOfWeek", "StateHoliday", "Assortment", "StoreType", "PromoInterval", 'month', 'woy','p_1','p_2','p_3','p_4'] for header in
    features]
